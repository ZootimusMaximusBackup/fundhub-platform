...
export function buildFundingSnapshot(client) {
  ...
  h.push(`<p><b>You are fundable right now. A personal loan is within reach today. But you
  ...
  h.push("<p>No business entity on file. You are leaving a full suite of business funding "
  ...
  h.push('<ul class="plain">' + fastestWins(c).map((w) => `<li>${esc(w)}</li>`).join("") + "</ul>");
  h.push("<p>Those three moves alone can push your score past 680 and your pre-approval "
    + "past $15,000.</p>");
  h.push(ctaPage(c));
  return h.join("");
}
