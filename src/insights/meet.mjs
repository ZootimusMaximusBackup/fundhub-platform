// Interview Meet booking helpers. No outbound calls. The live book page is
// ClickFunnels; a Meet URL may arrive on booking.created.
...
/** Booking link the funding advisor sends for the post-funding interview. */
export function meetBookingUrl(env = process.env) {
  return pickUrl(env, "INSIGHT_MEET_BOOKING_URL");
}

/** Sales-call booking page — clients book the strategy session here. */
