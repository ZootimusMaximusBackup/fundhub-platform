...
//
// WHERE THEY LAND. Whatever DOCUMENT_STORE_PROVIDER selects in store.mjs —
// memory by default, Vercel Blob or Netlify Blobs when configured — the same
// provider every other document in this codebase uses. providerFromEnv() in
// store.mjs picks; nothing here knows which it got.
//
