...
-- same closing line every text the product already sends carries (db/seed/011,
-- db/seed/013). CORRECTED 2026-09-04: an earlier version of this header called
-- it the exact wording carried on the application form. It is not. The form
-- (public/js/homepage-survey.js) carries a longer consent sentence that also
-- names message frequency, HELP, and the privacy policy. Nothing here is worse
-- than what ships today, but the claim was wrong and is withdrawn.
