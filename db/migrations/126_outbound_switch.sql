-- 126_outbound_switch.sql — outbound email stops being a thing nobody can turn on.
--
-- ═══════════════════════════════════════════════════════════════════════════
...
COMMENT ON TABLE messaging_settings IS
  'Per-company outbound mail settings. outbound_enabled is a PAUSE button, not an ignition key — the real control is provider credentials. See db/migrations/126_outbound_switch.sql.';
