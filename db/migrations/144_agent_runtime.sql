-- 144_agent_runtime.sql — tables and columns the agent runtime needs to
...
--   3. Renumbered at merge from 142 → 144: main already had
--      142_staff_monitoring_consent.sql and 143_inquiry_removal_bridge.sql.
