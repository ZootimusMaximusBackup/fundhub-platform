-- 116_template_approval.sql — an audit trail for message_templates.compliance_passed.
--
-- RENUMBERED FROM 114_template_approval.sql at the eleven-branch merge, 2026-08-01:
-- `114` was already taken by 114_ghl_agent_seed.sql, and 115 by
-- 115_affiliates_white_label.sql, both of which landed on main first. This file
-- had never been applied anywhere under its old number, so this is a plain
-- rename with no schema_migrations key to supersede.
--
