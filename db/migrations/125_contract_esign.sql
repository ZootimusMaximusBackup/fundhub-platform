-- 125_contract_esign.sql — uploaded PDFs, placed fields, and several signers in order.
--
...
--
-- DEPENDS ON: 124_contracts.sql, 030_documents.sql (the uploaded PDF and the
...
COMMENT ON COLUMN contract_templates.fields IS
  'Boxes placed on the pages. Positions are FRACTIONS of the page, never pixels — see the column note in db/migrations/125_contract_esign.sql.';

-- ---------------------------------------------------------------------------
-- 4. `fields` joins the frozen set.
--
