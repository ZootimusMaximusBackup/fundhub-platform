...
|---|---|---|
| [client](./client-actual.md) | `client` | reaches 11 of 78 routes |
| [role-owner](./role-owner-actual.md) | `owner` | reaches 78 of 78 routes |
| [role-sales-manager](./role-sales-manager-actual.md) | `sales_manager` | reaches 61 of 78 routes |
| [role-closer](./role-closer-actual.md) | `closer` | reaches 49 of 78 routes |
| [role-funding-advisor](./role-funding-advisor-actual.md) | `funding_advisor` | reaches 50 of 78 routes |
| [role-inquiry-remover](./role-inquiry-remover-actual.md) | `inquiry_specialist` | reaches 49 of 78 routes |
| [affiliate](./affiliate-actual.md) | `affiliate` | reaches 8 of 78 routes |
| [white-label](./white-label-actual.md) | `partner` | reaches 19 of 78 routes |

## What was found while generating these

- **78 routes** are reachable in total.
