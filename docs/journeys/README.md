...
|---|---|---|
| [client](./client-actual.md) | `client` | reaches 13 of 79 routes |
| [role-owner](./role-owner-actual.md) | `owner` | reaches 79 of 79 routes |
| [role-sales-manager](./role-sales-manager-actual.md) | `sales_manager` | reaches 62 of 79 routes |
| [role-closer](./role-closer-actual.md) | `closer` | reaches 51 of 79 routes |
| [role-funding-advisor](./role-funding-advisor-actual.md) | `funding_advisor` | reaches 52 of 79 routes |
| [role-inquiry-remover](./role-inquiry-remover-actual.md) | `inquiry_specialist` | reaches 51 of 79 routes |
| [affiliate](./affiliate-actual.md) | `affiliate` | reaches 10 of 79 routes |
| [white-label](./white-label-actual.md) | `partner` | reaches 21 of 79 routes |

## What was found while generating these

- **79 routes** are reachable in total.
