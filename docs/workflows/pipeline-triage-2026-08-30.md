...
- **Playwright** — 13 new browser tests in `e2e/pipeline-waiting-on.spec.mjs`, covering a 40-card board, a failed read, an empty rail, the click-to-jump, the filter, and 390px. Run with `screens-smoke` and `funded-amount`: **73 pass, 0 fail.**
