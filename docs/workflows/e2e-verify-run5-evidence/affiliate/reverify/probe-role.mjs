...
// REVERIFY COPY (auditor, 2026-08-17): only this line differs from _tools/probe-role.mjs —
// output lands in <journey>/reverify/ while the -actual.md path stays on the real journey name.
