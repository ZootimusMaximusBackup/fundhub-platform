# affiliate/reverify — live UI walk

Ran 2026-08-17T05:39:40.846Z against https://fundhub.ai as `affiliate@fundhub.ai`.

| Step | Result | Evidence |
|---|---|---|
| Login page | shown | docs/workflows/e2e-verify-run5-evidence/affiliate/reverify/shots/00-login-page.png |
| Sign in | left login.html · role stored=affiliate · api fails=0 | docs/workflows/e2e-verify-run5-evidence/affiliate/reverify/shots/01-landing.png |
| Landed at | /app/affiliate.html (Fundhub — Affiliate) | docs/workflows/e2e-verify-run5-evidence/affiliate/reverify/shots/01-landing.png |
| App shell | /app/affiliate.html | docs/workflows/e2e-verify-run5-evidence/affiliate/reverify/shots/02-app-shell.png |
...
|---|---|---|---|---|---|---|
|  (`/app/affiliate.html`) | 200 | /app/affiliate.html | no | — | — | docs/workflows/e2e-verify-run5-evidence/affiliate/reverify/shots/03-_app_affiliate.html.png |
| ⇗AffiliateBETA (`affiliate.html`) | 200 | /app/affiliate.html | no | — | — | docs/workflows/e2e-verify-run5-evidence/affiliate/reverify/shots/04-affiliate.html.png |
