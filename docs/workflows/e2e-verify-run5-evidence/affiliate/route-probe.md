# affiliate — live route probe

Ran 2026-08-17T04:01:06.734Z against https://fundhub.ai as `affiliate@fundhub.ai`.

| Check | Result |
|---|---|
| Login | HTTP 200, ok=true, role=—, token=true, cookie=false |
| Session | HTTP 200, role=affiliate |
| Not signed in → 401 | 2/2 correct |
| Should reach | 5/6 probed OK · 14 UNVERIFIED (write-only) · 1 FAIL |
| Should stay blocked | 34/126 probed 403 · 10 UNVERIFIED · 92 FAIL |
...
| reach | contracts | 1 | 1 |
| reach | Documents | 1 | 1 |
| reach | Everything else | 2 | 5 ⚠️ |
| reach | Incoming webhooks | 1 | 1 |
| reach | climate | 0 | 2 ⚠️ |
| reach | public | 0 | 3 ⚠️ |
| reach | Reading data | 0 | 1 ⚠️ |
...
| blocked | privacy | 1 | 1 |
| blocked | Reading data | 26 | 45 ⚠️ |
| blocked | Everything else | 13 | 26 ⚠️ |
| blocked | chat | 0 | 4 ⚠️ |
