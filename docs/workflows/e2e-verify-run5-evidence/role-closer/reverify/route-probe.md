# role-closer — live route probe

Ran 2026-08-17T05:38:03.624Z against https://fundhub.ai as `closer@fundhub.ai`.

| Check | Result |
|---|---|
| Login | HTTP 200, ok=true, role=closer, token=true, cookie=true |
| Session | HTTP 200, role=closer |
| Not signed in → 401 | 6/6 correct |
| Should reach | 57/59 probed OK · 49 UNVERIFIED (write-only) · 2 FAIL |
| Should stay blocked | 47/47 probed 403 · 1 UNVERIFIED · 0 FAIL |
