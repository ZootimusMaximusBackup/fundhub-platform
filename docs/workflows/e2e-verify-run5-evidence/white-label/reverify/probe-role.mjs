...
// REVERIFY COPY (auditor, 2026-08-17): output goes to <journey>/reverify/; the
// -actual.md path below still uses the real journey name. Only this line differs
// from _tools/probe-role.mjs.
