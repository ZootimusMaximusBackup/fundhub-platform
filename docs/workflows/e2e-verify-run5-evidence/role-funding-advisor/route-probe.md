# role-funding-advisor — live route probe

Ran 2026-08-17T03:37:01.743Z against https://fundhub.ai as `advisor@fundhub.ai`.

| Check | Result |
|---|---|
| Login | HTTP 200, ok=true, role=funding_advisor, token=true, cookie=true |
| Session | HTTP 200, role=funding_advisor |
| Not signed in → 401 | 6/6 correct |
| Should reach | 57/60 probed OK · 51 UNVERIFIED (write-only) · 3 FAIL |
| Should stay blocked | 44/44 probed 403 · 1 UNVERIFIED · 0 FAIL |
...
| reach | Documents | 1 | 1 |
| reach | Finance | 5 | 5 |
| reach | Reading data | 19 | 36 ⚠️ |
| reach | Everything else | 11 | 23 ⚠️ |
...
| blocked | privacy | 1 | 1 |
| blocked | Reading data | 7 | 10 ⚠️ |
| blocked | Everything else | 4 | 8 ⚠️ |
| blocked | chat | 0 | 1 ⚠️ |
