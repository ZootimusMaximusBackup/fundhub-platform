# client — live route probe

Ran 2026-08-17T04:01:14.202Z against https://fundhub.ai as `client@fundhub.ai`.

| Check | Result |
|---|---|
| Login | HTTP 200, ok=true, role=—, token=true, cookie=false |
| Session | HTTP 200, role=client |
| Not signed in → 401 | 6/6 correct |
| Should reach | 9/10 probed OK · 16 UNVERIFIED (write-only) · 1 FAIL |
| Should stay blocked | 28/120 probed 403 · 10 UNVERIFIED · 92 FAIL |
...
| reach | Documents | 1 | 1 |
| reach | Finance | 1 | 1 |
| reach | Reading data | 1 | 3 ⚠️ |
| reach | Everything else | 3 | 6 ⚠️ |
...
| blocked | banking | 3 | 3 |
| blocked | Campaigns | 6 | 8 ⚠️ |
| blocked | Creative Factory | 4 | 7 ⚠️ |
| blocked | The dashboard | 4 | 6 ⚠️ |
| blocked | Finance | 9 | 9 |
| blocked | Hiring | 6 | 6 |
| blocked | journeys | 2 | 2 |
| blocked | privacy | 1 | 1 |
| blocked | Reading data | 25 | 43 ⚠️ |
| blocked | Everything else | 12 | 25 ⚠️ |
| blocked | chat | 0 | 3 ⚠️ |
...
| `/api/read/company-brain-affiliate` | POST | 401 | unauthorized | affiliate, partner |
...
|---|---|
| `/api/consent/capture` | 401 |
| `/api/finance/soft-pull` | 401 |
| `/api/org-brand` | 401 |
| `/api/read/entitlements` | 401 |
| `/api/read/portal-contracts` | 401 |
| `/api/read/portal-summary` | 401 |
...
| reach | `/api/chat/portal-message` | POST | — | UNVERIFIED — write-only route, not probed |
...
| reach | `/api/read/portal-contracts` | GET | 200 |  |
| reach | `/api/read/portal-summary` | GET | 200 |  |
...
| blocked | `/api/campaigns/action-log` | GET | 403 | forbidden |
| blocked | `/api/campaigns/connections` | GET | 403 | forbidden |
| blocked | `/api/campaigns/detail` | GET | 403 | forbidden |
| blocked | `/api/campaigns/fatigue` | GET | 403 | forbidden |
| blocked | `/api/campaigns/list` | GET | 403 | forbidden |
| blocked | `/api/campaigns/spend` | GET | 403 | forbidden |
| blocked | `/api/campaigns/sync` | POST | 403 | forbidden |
| blocked | `/api/campaigns/write` | POST | 403 | forbidden |
...
| blocked | `/api/creative/actions` | POST | 403 | forbidden |
| blocked | `/api/creative/approvals` | GET | 403 | forbidden |
| blocked | `/api/creative/brand-kits` | GET | 403 | forbidden |
| blocked | `/api/creative/generate` | POST | 403 | forbidden |
| blocked | `/api/creative/jobs` | GET | 403 | forbidden |
| blocked | `/api/creative/library` | GET | 403 | forbidden |
| blocked | `/api/creative/run` | POST | 403 | forbidden |
...
| blocked | `/api/read/company-brain-affiliate` | POST | 401 | unauthorized |
...
| blocked | `/api/social/publish` | POST | 403 | forbidden |
| blocked | `/api/social/schedule` | POST | 403 | forbidden |
