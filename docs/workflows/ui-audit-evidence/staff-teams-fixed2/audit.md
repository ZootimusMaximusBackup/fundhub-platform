# UI audit evidence — staff-teams-fixed2 as owner@fundhub.ai

Ran 2026-08-17T17:48:58.075Z against https://fundhub.ai. Login ok (role owner). Screen /app/staff-teams.html → HTTP 200, final /app/staff-teams.html, title "Fundhub — Staff & Teams".

Shots: docs/workflows/ui-audit-evidence/staff-teams-fixed2/1440-fold.png · docs/workflows/ui-audit-evidence/staff-teams-fixed2/1440-full.png · docs/workflows/ui-audit-evidence/staff-teams-fixed2/390-full.png
...
| 2 | button "Roster" | 74×41 | NOOP |  | docs/workflows/ui-audit-evidence/staff-teams-fixed2/clicks/02-NOOP-Roster.png |
