# UI audit evidence — company-brain/fixed as advisor@fundhub.ai

Ran 2026-08-17T10:25:30.263Z against https://fundhub.ai. Login ok (role funding_advisor). Screen /app/company-brain.html → HTTP 200, final /app/company-brain.html, title "Fundhub — Company Brain".

Shots: docs/workflows/ui-audit-evidence/company-brain/fixed/1440-fold.png · docs/workflows/ui-audit-evidence/company-brain/fixed/1440-full.png · docs/workflows/ui-audit-evidence/company-brain/fixed/390-full.png
...
## Click sweep
- 4 clicked of 4 candidates (cap 80) · tally: OK=4
