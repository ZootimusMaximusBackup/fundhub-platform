# UI audit evidence — offerstack-live-my-numbers as closer@fundhub.ai

Ran 2026-08-18T03:53:25.953Z against https://fundhub.ai. Login FAILED (role —). Screen /app/my-numbers.html → HTTP 200, final /login.html?next=/app/my-numbers.html, title "Sign in | fundhub".

Shots: docs/workflows/ui-audit-evidence/offerstack-live-my-numbers/1440-fold.png · docs/workflows/ui-audit-evidence/offerstack-live-my-numbers/1440-full.png · docs/workflows/ui-audit-evidence/offerstack-live-my-numbers/390-full.png

## Load
- API calls: 4; failing: GET /api/read/my-numbers → 401; GET /api/auth/session → 401; GET /api/auth/session → 401
...
## Mobile (390×844)
- Horizontal overflow: no · sidebar visible false (0px) · burger false · elements past right edge: none · text under 11px: 0 · api fails: 3
