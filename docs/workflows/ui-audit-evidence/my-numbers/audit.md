# UI audit evidence — my-numbers as closer@fundhub.ai

Ran 2026-08-17T15:48:45.150Z against https://fundhub.ai. Login ok (role closer). Screen /app/my-numbers.html → HTTP 200, final /app/my-numbers.html, title "My numbers · Fundhub".

Shots: docs/workflows/ui-audit-evidence/my-numbers/1440-fold.png · docs/workflows/ui-audit-evidence/my-numbers/1440-full.png · docs/workflows/ui-audit-evidence/my-numbers/390-full.png
...
## DOM read (1440×900)
- Page height 1754px (fold 900) · content width 1440px (div.app-shell) · sidebar 228px
