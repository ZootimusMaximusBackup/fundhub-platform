# UI audit evidence — agent-editor/nonsales-fix as owner@fundhub.ai

Ran 2026-08-17T19:28:26.391Z against https://fundhub.ai. Login ok (role owner). Screen /app/agent-editor.html → HTTP 200, final /app/agent-editor.html, title "Fundhub — Agent Editor".

Shots: docs/workflows/ui-audit-evidence/agent-editor/nonsales-fix/1440-fold.png · docs/workflows/ui-audit-evidence/agent-editor/nonsales-fix/1440-full.png · docs/workflows/ui-audit-evidence/agent-editor/nonsales-fix/390-full.png
