# UI audit evidence — pipeline-mlfix as closer@fundhub.ai

Ran 2026-08-17T19:37:19.899Z against https://fundhub.ai. Login ok (role closer). Screen /app/pipeline.html → HTTP 200, final /app/pipeline.html, title "Fundhub — Pipeline".

Shots: docs/workflows/ui-audit-evidence/pipeline-mlfix/1440-fold.png · docs/workflows/ui-audit-evidence/pipeline-mlfix/1440-full.png · docs/workflows/ui-audit-evidence/pipeline-mlfix/390-full.png
...
- Top-left element: header "Fundhub / Pipeline Org: Fundhub Mon, Aug 17, 3:37:29 PM EDT LIVE"
- H1: — · H2s: —
