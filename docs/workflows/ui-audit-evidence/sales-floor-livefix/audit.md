# UI audit evidence — sales-floor-livefix as sales@fundhub.ai

Ran 2026-08-17T19:32:37.967Z against https://fundhub.ai. Login ok (role sales_manager). Screen /app/sales-floor.html → HTTP 200, final /app/sales-floor.html, title "Sales floor · Fundhub".

Shots: docs/workflows/ui-audit-evidence/sales-floor-livefix/1440-fold.png · docs/workflows/ui-audit-evidence/sales-floor-livefix/1440-full.png · docs/workflows/ui-audit-evidence/sales-floor-livefix/390-full.png
...
- Font sizes in use (8): 28px×7, 14px×82, 13px×1, 12px×1, 11.5px×1, 11px×6, 10px×1, 9px×2
