# UI audit evidence — agent-editor-mlfix as owner@fundhub.ai

Ran 2026-08-17T19:40:10.293Z against https://fundhub.ai. Login ok (role owner). Screen /app/agent-editor.html → HTTP 200, final /app/agent-editor.html, title "Fundhub — Agent Editor".

Shots: docs/workflows/ui-audit-evidence/agent-editor-mlfix/1440-fold.png · docs/workflows/ui-audit-evidence/agent-editor-mlfix/1440-full.png · docs/workflows/ui-audit-evidence/agent-editor-mlfix/390-full.png
...
## DOM read (1440×900)
- Page height 2004px (fold 900) · content width 1440px (div.app) · sidebar 228px
...
- Font sizes in use (7): 28px×4, 18px×1, 14px×142, 13px×1, 12px×1, 11px×56, 10px×1
...
- Uneven card rows: top 144: [956,230,230,230,230]
