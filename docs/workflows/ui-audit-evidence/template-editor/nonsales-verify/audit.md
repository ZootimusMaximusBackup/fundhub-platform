# UI audit evidence — template-editor/nonsales-verify as owner@fundhub.ai

Ran 2026-08-17T19:43:37.639Z against https://fundhub.ai. Login ok (role owner). Screen /app/template-editor.html → HTTP 200, final /app/template-editor.html, title "Fundhub — Message Copy".

Shots: docs/workflows/ui-audit-evidence/template-editor/nonsales-verify/1440-fold.png · docs/workflows/ui-audit-evidence/template-editor/nonsales-verify/1440-full.png · docs/workflows/ui-audit-evidence/template-editor/nonsales-verify/390-full.png
