# UI audit evidence — advisor-beta-r1-documents as advisor@fundhub.ai

Ran 2026-08-18T03:49:50.174Z against https://fundhub.ai. Login FAILED (role —). Screen /app/documents.html → HTTP 200, final /login.html?next=/app/documents.html, title "Sign in | fundhub".

Shots: docs/workflows/ui-audit-evidence/advisor-beta-r1-documents/1440-fold.png · docs/workflows/ui-audit-evidence/advisor-beta-r1-documents/1440-full.png · docs/workflows/ui-audit-evidence/advisor-beta-r1-documents/390-full.png
