...
Ran 2026-08-17T10:28:19.706Z against https://fundhub.ai. Login ok (role owner). Screen /app/staff-teams.html → HTTP 200, final /app/staff-teams.html, title "Fundhub — Staff & Teams".
...
- Font sizes in use (7): 28px×4, 18px×1, 14px×1, 13px×1, 12px×1, 11px×40, 10px×1
...
| 3 | button "Permissions reference" | 195×41 | OK |  |  |
| 4 | button "Clock & consent" | 146×41 | OK |  |  |
| 5 | button "Telemetry" | 98×41 | OK |  |  |
| 6 | button "Permissions reference →" | 194×29 | GONE | control not visible on re-locate (DOM changed after an earlier click) |  |
| 7 | tr "CSChris Stanbridgechris@fundhub.aiOwnerClients · Money · Mes" | 1162×60 | GONE | control not visible on re-locate (DOM changed after an earlier click) |  |
