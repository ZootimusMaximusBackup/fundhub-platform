# UI audit evidence — journeys-mlfix as owner@fundhub.ai

Ran 2026-08-17T19:40:41.485Z against https://fundhub.ai. Login ok (role owner). Screen /app/journeys.html → HTTP 200, final /app/journeys.html, title "Fundhub — Journeys".

Shots: docs/workflows/ui-audit-evidence/journeys-mlfix/1440-fold.png · docs/workflows/ui-audit-evidence/journeys-mlfix/1440-full.png · docs/workflows/ui-audit-evidence/journeys-mlfix/390-full.png
...
- Font sizes in use (6): 18px×1, 14px×74, 13px×1, 12px×1, 11px×8, 10px×1
...
## Mobile (390×844)
- Horizontal overflow: no · sidebar visible true (228px) · burger true · elements past right edge: button.jrow, span.nm, button.jrow, span.nm · text under 11px: 1 · api fails: 0
