# UI audit evidence — brand-studio-mlfix as partner@fundhub.ai

Ran 2026-08-17T19:39:33.284Z against https://fundhub.ai. Login ok (role partner). Screen /app/brand-studio.html → HTTP 200, final /app/brand-studio.html, title "Fundhub — Brand Studio".

Shots: docs/workflows/ui-audit-evidence/brand-studio-mlfix/1440-fold.png · docs/workflows/ui-audit-evidence/brand-studio-mlfix/1440-full.png · docs/workflows/ui-audit-evidence/brand-studio-mlfix/390-full.png
...
- Tables: none
- Metric-ish elements: "BS-00 / BRANDText markwordmark"@14px, "BS-00 / BRANDText markwordmark"@14px, "BS-00 / DOMAIN—not connected"@14px, "BS-00 / FUNNELS SELECTED0ticke"@14px, "BS-00 / COMPLIANCELockedmaster"@14px, "8 values, everything renders f"@11px
