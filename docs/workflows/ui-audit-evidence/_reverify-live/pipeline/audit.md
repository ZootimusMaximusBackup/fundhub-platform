# UI audit evidence — _reverify-live/pipeline as closer@fundhub.ai

Ran 2026-08-17T20:17:52.905Z against https://fundhub.ai. Login ok (role closer). Screen /app/pipeline.html → HTTP 200, final /app/pipeline.html, title "Fundhub — Pipeline".

Shots: docs/workflows/ui-audit-evidence/_reverify-live/pipeline/1440-fold.png · docs/workflows/ui-audit-evidence/_reverify-live/pipeline/1440-full.png · docs/workflows/ui-audit-evidence/_reverify-live/pipeline/390-full.png
...
- Top-left element: header "Fundhub / Pipeline Org: Fundhub Mon, Aug 17, 4:17:59 PM EDT LIVE"
- H1: — · H2s: —
- Nav: 5 visible items · active: ▤Pipeline · groups: Sales▾(5), Funding▾(0), Client ops▾(0), Watch▾(0), Automation▾(0), Marketing▾(0), Admin▾(0)
- Font sizes in use (5): 14px×33, 13px×1, 12px×1, 11px×56, 10px×1
