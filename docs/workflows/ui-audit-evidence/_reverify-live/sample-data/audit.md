# UI audit evidence — _reverify-live/sample-data as owner@fundhub.ai

Ran 2026-08-17T20:15:14.779Z against https://fundhub.ai. Login ok (role owner). Screen /app/sample-data.html → HTTP 200, final /app/sample-data.html, title "FundHub — Demo Mode".

Shots: docs/workflows/ui-audit-evidence/_reverify-live/sample-data/1440-fold.png · docs/workflows/ui-audit-evidence/_reverify-live/sample-data/1440-full.png · docs/workflows/ui-audit-evidence/_reverify-live/sample-data/390-full.png
