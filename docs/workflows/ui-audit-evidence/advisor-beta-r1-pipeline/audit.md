# UI audit evidence — advisor-beta-r1-pipeline as advisor@fundhub.ai

Ran 2026-08-18T03:42:03.506Z against https://fundhub.ai. Login FAILED (role —). Screen /app/pipeline.html → HTTP 200, final /login.html?next=/app/pipeline.html, title "Sign in | fundhub".

Shots: docs/workflows/ui-audit-evidence/advisor-beta-r1-pipeline/1440-fold.png · docs/workflows/ui-audit-evidence/advisor-beta-r1-pipeline/1440-full.png · docs/workflows/ui-audit-evidence/advisor-beta-r1-pipeline/390-full.png
