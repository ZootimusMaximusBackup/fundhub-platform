# UI audit evidence — client-control-panel-mlfix as advisor@fundhub.ai

Ran 2026-08-17T19:42:07.276Z against https://fundhub.ai. Login ok (role funding_advisor). Screen /app/client-control-panel.html → HTTP 200, final /app/client-control-panel.html, title "Fundhub — Client Control Panel".

Shots: docs/workflows/ui-audit-evidence/client-control-panel-mlfix/1440-fold.png · docs/workflows/ui-audit-evidence/client-control-panel-mlfix/1440-full.png · docs/workflows/ui-audit-evidence/client-control-panel-mlfix/390-full.png
...
- Top-left element: header "/ Client Control Panel Org: Fundhub Mon, Aug 17, 3:42:21 PM EDT LIVE"
- H1: — · H2s: —
