# UI audit evidence — finance-os/nonsales-fix as advisor@fundhub.ai

Ran 2026-08-17T19:29:09.294Z against https://fundhub.ai. Login ok (role funding_advisor). Screen /app/finance-os.html?client_id=8556bedc-46e1-4d85-b0cd-a24adfee1521 → HTTP 200, final /app/finance-os.html?client_id=8556bedc-46e1-4d85-b0cd-a24adfee1521, title "Fundhub — Finance OS".

Shots: docs/workflows/ui-audit-evidence/finance-os/nonsales-fix/1440-fold.png · docs/workflows/ui-audit-evidence/finance-os/nonsales-fix/1440-full.png · docs/workflows/ui-audit-evidence/finance-os/nonsales-fix/390-full.png
...
## DOM read (1440×900)
- Page height 3712px (fold 900) · content width 1440px (div.app) · sidebar 228px
...
- Font sizes in use (7): 28px×4, 18px×11, 14px×69, 13px×1, 12px×1, 11px×15, 10px×1
