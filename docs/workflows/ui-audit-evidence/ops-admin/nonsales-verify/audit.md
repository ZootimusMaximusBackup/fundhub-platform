# UI audit evidence — ops-admin/nonsales-verify as owner@fundhub.ai

Ran 2026-08-17T19:42:57.826Z against https://fundhub.ai. Login ok (role owner). Screen /app/ops-admin.html → HTTP 200, final /app/ops-admin.html, title "Fundhub — Ops & Admin".

Shots: docs/workflows/ui-audit-evidence/ops-admin/nonsales-verify/1440-fold.png · docs/workflows/ui-audit-evidence/ops-admin/nonsales-verify/1440-full.png · docs/workflows/ui-audit-evidence/ops-admin/nonsales-verify/390-full.png
