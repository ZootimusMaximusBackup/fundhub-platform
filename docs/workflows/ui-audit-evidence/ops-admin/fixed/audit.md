# UI audit evidence — ops-admin/fixed as owner@fundhub.ai

Ran 2026-08-17T10:27:42.572Z against https://fundhub.ai. Login ok (role owner). Screen /app/ops-admin.html → HTTP 200, final /app/ops-admin.html, title "Fundhub — Ops & Admin".

Shots: docs/workflows/ui-audit-evidence/ops-admin/fixed/1440-fold.png · docs/workflows/ui-audit-evidence/ops-admin/fixed/1440-full.png · docs/workflows/ui-audit-evidence/ops-admin/fixed/390-full.png
...
## Click sweep
- 10 clicked of 10 candidates (cap 80) · tally: OK=4, DIALOG=1, NAV=1, NOOP=2, GONE=2

| # | Control | Size | Result | What happened | Shot |
|---|---|---|---|---|---|
| 1 | button "Dismiss" | 64×19 | OK |  |  |
| 2 | button "Last 7 Days — Aug 11–17▾" | 156×36 | OK |  |  |
| 3 | button "Turn ON" | 83×36 | DIALOG | dialog: confirm "Turn Demo Mode ON? This seeds fictional clients and lenders into this live org, and every screen shows them until you turn it back off." |  |
| 4 | a "Open Demo Mode screen →" | 188×17 | NAV | → /app/sample-data.html · GET /api/auth/session 200; GET /api/demo/mode 200; GET /api/health 200; GET /api/org-brand 200; GET /api/demo/mode 200 |  |
| 5 | button "MoneyKPIs · AR · compliance" | 200×31 | NOOP |  | docs/workflows/ui-audit-evidence/ops-admin/fixed/clicks/05-NOOP-MoneyKPIs_AR_compliance.png |
| 6 | button "Peoplestaff, comp & consent" | 197×31 | OK |  |  |
| 7 | summary "› Affiliates + Hiring — referrals · — paid out · — applicant" | 1162×40 | GONE | control not visible on re-locate (DOM changed after an earlier click) |  |
| 8 | a "Open Affiliates ↗" | 111×22 | GONE | control not visible on re-locate (DOM changed after an earlier click) |  |
| 9 | button "Search⌘K" | 99×36 | NOOP |  | docs/workflows/ui-audit-evidence/ops-admin/fixed/clicks/09-NOOP-Search_K.png |
| 10 | button "Chat" | 52×52 | OK |  |  |
