# UI audit evidence — ops-admin/nonsales-fix as owner@fundhub.ai

Ran 2026-08-17T19:28:06.787Z against https://fundhub.ai. Login ok (role owner). Screen /app/ops-admin.html → HTTP 200, final /app/ops-admin.html, title "Fundhub — Ops & Admin".

Shots: docs/workflows/ui-audit-evidence/ops-admin/nonsales-fix/1440-fold.png · docs/workflows/ui-audit-evidence/ops-admin/nonsales-fix/1440-full.png · docs/workflows/ui-audit-evidence/ops-admin/nonsales-fix/390-full.png
