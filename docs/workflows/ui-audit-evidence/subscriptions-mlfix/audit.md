# UI audit evidence — subscriptions-mlfix as owner@fundhub.ai

Ran 2026-08-17T19:39:56.687Z against https://fundhub.ai. Login ok (role owner). Screen /app/subscriptions.html → HTTP 200, final /app/subscriptions.html, title "Fundhub — Subscriptions".

Shots: docs/workflows/ui-audit-evidence/subscriptions-mlfix/1440-fold.png · docs/workflows/ui-audit-evidence/subscriptions-mlfix/1440-full.png · docs/workflows/ui-audit-evidence/subscriptions-mlfix/390-full.png
...
## DOM read (1440×900)
- Page height 994px (fold 900) · content width 1440px (div.app) · sidebar 228px
...
- Font sizes in use (6): 18px×3, 14px×19, 13px×1, 12px×1, 11px×4, 10px×1
