# UI audit evidence — command-center/nonsales-fix as owner@fundhub.ai

Ran 2026-08-17T19:26:52.396Z against https://fundhub.ai. Login ok (role owner). Screen /app/command-center.html → HTTP 200, final /app/command-center.html, title "Fundhub — Command Center".

Shots: docs/workflows/ui-audit-evidence/command-center/nonsales-fix/1440-fold.png · docs/workflows/ui-audit-evidence/command-center/nonsales-fix/1440-full.png · docs/workflows/ui-audit-evidence/command-center/nonsales-fix/390-full.png
