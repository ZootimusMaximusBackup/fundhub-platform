# UI audit evidence — beta-r1-pipeline as closer@fundhub.ai

Ran 2026-08-18T03:42:52.047Z against https://fundhub.ai. Login FAILED (role —). Screen /app/pipeline.html → HTTP 200, final /login.html?next=/app/pipeline.html, title "Sign in | fundhub".

Shots: docs/workflows/ui-audit-evidence/beta-r1-pipeline/1440-fold.png · docs/workflows/ui-audit-evidence/beta-r1-pipeline/1440-full.png · docs/workflows/ui-audit-evidence/beta-r1-pipeline/390-full.png
