# UI audit evidence — content-admin/fixed as owner@fundhub.ai

Ran 2026-08-17T10:40:15.983Z against https://fundhub.ai. Login ok (role owner). Screen /app/content-admin.html → HTTP 200, final /app/command-center.html **BOUNCED**, title "Fundhub — Command Center".

Shots: docs/workflows/ui-audit-evidence/content-admin/fixed/1440-fold.png · docs/workflows/ui-audit-evidence/content-admin/fixed/1440-full.png · docs/workflows/ui-audit-evidence/content-admin/fixed/390-full.png
