# UI audit evidence — beta-r1-messaging as closer@fundhub.ai

Ran 2026-08-18T03:50:29.624Z against https://fundhub.ai. Login FAILED (role —). Screen /app/messaging.html → HTTP 200, final /login.html?next=/app/messaging.html, title "Sign in | fundhub".

Shots: docs/workflows/ui-audit-evidence/beta-r1-messaging/1440-fold.png · docs/workflows/ui-audit-evidence/beta-r1-messaging/1440-full.png · docs/workflows/ui-audit-evidence/beta-r1-messaging/390-full.png
