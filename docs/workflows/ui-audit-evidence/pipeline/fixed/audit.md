# UI audit evidence — pipeline/fixed as closer@fundhub.ai

Ran 2026-08-17T10:42:32.389Z against https://fundhub.ai. Login ok (role closer). Screen /app/pipeline.html → HTTP 200, final /app/pipeline.html, title "Fundhub — Pipeline".

Shots: docs/workflows/ui-audit-evidence/pipeline/fixed/1440-fold.png · docs/workflows/ui-audit-evidence/pipeline/fixed/1440-full.png · docs/workflows/ui-audit-evidence/pipeline/fixed/390-full.png
...
- Top-left element: header "Fundhub / Pipeline Org: Fundhub Mon, Aug 17, 6:42:39 AM EDT LIVE"
- H1: — · H2s: —
...
| 4 | div "FRFrancis RawlinsMOVEDEL⠿——4d in stageunassigned" | 222×110 | OK | GET /api/dashboard/client 200 |  |
...
| 8 | div "RRRick RockwellMOVEDEL⠿580-649—2d in stageunassigned" | 222×110 | OK | GET /api/dashboard/client 200 |  |
