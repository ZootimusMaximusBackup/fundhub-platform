# UI audit evidence — documents-mlfix as advisor@fundhub.ai

Ran 2026-08-17T19:35:38.739Z against https://fundhub.ai. Login ok (role funding_advisor). Screen /app/documents.html → HTTP 200, final /app/documents.html, title "Fundhub — Documents".

Shots: docs/workflows/ui-audit-evidence/documents-mlfix/1440-fold.png · docs/workflows/ui-audit-evidence/documents-mlfix/1440-full.png · docs/workflows/ui-audit-evidence/documents-mlfix/390-full.png
...
## DOM read (1440×900)
- Page height 981px (fold 900) · content width 1440px (div.app) · sidebar 228px
...
- Font sizes in use (7): 28px×4, 18px×1, 14px×39, 13px×1, 12px×1, 11px×56, 10px×1
- Primary-looking (filled) buttons: 1 — "Chat"
- Generic labels: none · targets under 40px: 7
