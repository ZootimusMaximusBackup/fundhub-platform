...
Ran 2026-08-17T10:40:00.405Z against https://fundhub.ai. Login ok (role owner). Screen /app/campaign-manager.html → HTTP 200, final /app/command-center.html **BOUNCED**, title "Fundhub — Command Center".
