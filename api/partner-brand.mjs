...
// brand tokens. The WRITE was gated the whole time — canAccessBrand() below,
// which was named canWrite when only the write called it — which is what made
// this easy to miss: the file looks gated, and half of it was.
//
